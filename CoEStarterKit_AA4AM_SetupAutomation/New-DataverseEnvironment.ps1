Function New-DataverseEnvironment {
    <#
        ...
        .EXAMPLE
            PS> New-DataverseEnvironment -DisplayName "Demonstration" -ConfigurationFilePath ".\DataverseEnvironmentConfiguration.txt"
        ...
        .EXAMPLE
            PS> New-DataverseEnvironment -DisplayName "Demonstration" -Description "Demonstration" -Sku "Sandbox" -SecurityGroupId "00000000-0000-0000-0000-000000000000" -ConfigurationFilePath ".\DataverseEnvironmentConfiguration.txt"
            EnvironmentName                            : 00000000-0000-0000-0000-000000000000
            DisplayName                                : Example (example)
            Description                                :
            IsDefault                                  : False
    ...
    Process{
        ...
        # Generate a domain name based on the provided display name
